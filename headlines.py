...
def home():
    publication = request.args.get("publication") #get the form from home.html
    if not publication:
    ...
    return render_template("home.html",articles = articles,\
                                        ...
                                        rate=rate,\
                                        currencies=sorted(currencies)) #there are sent to home.html
...
def get_weather(query):
    #api_url = 'http://api.openweathermap.org/data/2.5/weather?q={}&units=metric&appid=403808e9c5f820a7ac7e14c69258d7f8'
...
def get_rate(frm,to):
    ...
    return (round(to_rate/frm_rate,3),parsed.keys())
